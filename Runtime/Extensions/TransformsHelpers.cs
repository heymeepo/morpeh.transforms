...
namespace Scellecs.Morpeh.Transforms
{
    ...
    /// </summary>
    [BurstCompile]
    public static class TransformsHelpers
    {
        ...
        //public static unsafe void ComputeWorldTransformMatrix(in EntityId entity, out float4x4 outputMatrix,
        ...
        //    var entities = stackalloc EntityId[fixedListCapacity];
        //    NativeList<EntityId> entitiesDynamicList = default;
        ...
        //            entitiesDynamicList = new NativeList<EntityId>(2 * fixedListCapacity, Allocator.TempJob);
