...
namespace Scellecs.Morpeh.Transforms
{
    ...
    public struct LocalTransform : IComponent
    {
        ...
        public quaternion TransformRotation(quaternion rotation) => math.mul(this.rotation, rotation);
        ...
        /// <param name="rotation">The rotation to be transformed.</param>
        /// <returns>The rotation after transformation.</returns>
        public quaternion InverseTransformRotation(quaternion rotation) => math.mul(math.conjugate(this.rotation), rotation);
        ...
        public float TransformScale(float scale) => scale * this.scale;
        ...
        /// <param name="scale">The scale to be transformed.</param>
        /// <returns>The scale after transformation.</returns>
        public float InverseTransformScale(float scale) => scale / this.scale;
        ...
        public LocalTransform ApplyScale(float scale) => new() { position = position, scale = this.scale * scale, rotation = rotation };
        ...
        public LocalTransform Rotate(quaternion rotation) => new() { position = position, scale = scale, rotation = math.mul(this.rotation, rotation) };
